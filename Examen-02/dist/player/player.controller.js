...
let PlayerController = class PlayerController {
    ...
    findOne(id) { return this.playerService.findOne(id); }
    create(body) { return this.playerService.create(body); }
    update(id, body) { return this.playerService.update(id, body); }
    remove(id) { return this.playerService.remove(id); }
};
