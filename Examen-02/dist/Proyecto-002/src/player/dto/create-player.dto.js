...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Vinícius Júnior' }),
    __metadata("design:type", String)
], CreatePlayerDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Delantero' }),
    __metadata("design:type", String)
], CreatePlayerDto.prototype, "position", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'ID del equipo al que pertenece' }),
