...
let TeamController = class TeamController {
    ...
    findOne(id) { return this.teamService.findOne(id); }
    findPlayers(id) { return this.teamService.findWithPlayers(id); }
    create(body) { return this.teamService.create(body); }
    update(id, body) { return this.teamService.update(id, body); }
    remove(id) { return this.teamService.remove(id); }
};
